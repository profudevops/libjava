def call(String jobNametmp = 'jobNametmp', String NAMESPACE = 'NAMESPACE', String LTCORREO = 'LTCORREO', String urlcomponente='urlcomponente') {
 
 echo "********************Enviado Correo***********************************"
                        emailext body: 'hola'+
				"Favor de validar el componente, si esta correcto favor de darle click en el boton Componente valido  para que se le pueda enviar la ruta productiva <br> ruta nexus para validacion: $urlcomponente <br><br> usuario:"+ 
